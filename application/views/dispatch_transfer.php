...
<div class="wrapper">
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       <b>SRS</b>
        <small>SRS TRANSFER TO OTHER BRANCH -> <a href=""> YOU ARE HERE ( TRANSFER TO OTHER BRANCH )</a></small>
      </h1>
    </section>
...
<!-- jQuery UI 1.11.4 -->
<script src="AdminLTE-2.4.18/bower_components/jquery-ui/jquery-ui.min.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
  $.widget.bridge('uibutton', $.ui.button);
</script>
<script src="AdminLTE-2.4.18/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<script src="AdminLTE-2.4.18/bower_components/raphael/raphael.min.js"></script>
<script src="AdminLTE-2.4.18/bower_components/morris.js/morris.min.js"></script>
<script src="AdminLTE-2.4.18/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<script src="AdminLTE-2.4.18/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="AdminLTE-2.4.18/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="AdminLTE-2.4.18/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<script src="AdminLTE-2.4.18/bower_components/moment/min/moment.min.js"></script>
<script src="AdminLTE-2.4.18/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<script src="AdminLTE-2.4.18/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
...
<script src="AdminLTE-2.4.18/dist/js/pages/dashboard.js"></script>
